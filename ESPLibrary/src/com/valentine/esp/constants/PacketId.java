...
{ 
	...
	// V1 Gen2 (version V4.1000 and later) volume control packets
	reqCurrentVolume 			((byte)0x37, "reqCurrentVolume"),
	respCurrentVolume 			((byte)0x38, "respCurrentVolume"),
	reqWriteVolume 				((byte)0x39, "reqWriteVolume"),
	reqAbortAudioDelay 			((byte)0x3A, "reqAbortAudioDelay"),
	reqDisplayCurrentVolume		((byte)0x3B, "reqDisplayCurrentVolume"),
	reqAllVolume 				((byte)0x3C, "reqAllVolume"),
	respAllVolume 				((byte)0x3D, "respAllVolume"),
