...
public class InfDisplayInfoData 
{
	...
	/**
	 * Gets the first seven segment image.
	 */
	...
	/**
	 *	Gets the second seven segment image.
	 */
	...
	/**
	 * Gets the first band arrow indicator image.
	 */
	...
	/**
	 * Getst the second band arrow indicator image.
	 */
	...
	/**
	 * Gets the first auxillary data byte.
	 */
	...
	/**
	 * Gets the second auxillary data byte.
	 */
	...
	/**
	 * Gets the third auxillary data byte.
	 * 
	 */
	 ...
	 * 
	 * @param	bogeyCounterData containing data about the first seven segment image.
	 */
	 ...
	 * 
	 * @param	bogeyCounterData containing data about the second seven segment image.
	 */
	...
	/**
	 * Method to extract the V1 mode from the display data represented by this object.
	 */	
