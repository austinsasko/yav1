...
public class RequestAllSweepDefinitions extends ESPPacket 
{
	public RequestAllSweepDefinitions(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqAllSweepDefinitions.toByteValue();
