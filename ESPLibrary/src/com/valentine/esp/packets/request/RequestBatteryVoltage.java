...
public class RequestBatteryVoltage extends ESPPacket 
{
	public RequestBatteryVoltage(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqBatteryVoltage.toByteValue();
