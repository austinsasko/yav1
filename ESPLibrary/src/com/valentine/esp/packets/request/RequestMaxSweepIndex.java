...
public class RequestMaxSweepIndex extends ESPPacket 
{
	public RequestMaxSweepIndex(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqMaxSweepIndex.toByteValue();
