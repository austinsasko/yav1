...
public class RequestSerialNumber extends ESPPacket 
{
	byte m_destinationId;
	
	public RequestSerialNumber(Devices _valentineType, Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqSerialNumber.toByteValue();
