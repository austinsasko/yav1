...
public class RequestStartAlertData extends ESPPacket 
{
	public RequestStartAlertData(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqStartAlertData.toByteValue();
