...
public class RequestSweepSections extends ESPPacket 
{
	public RequestSweepSections(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqSweepSections.toByteValue();
