...
public class RequestTurnOnMainDisplay extends ESPPacket 
{
	public RequestTurnOnMainDisplay(Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqTurnOnMainDisplay.toByteValue();
