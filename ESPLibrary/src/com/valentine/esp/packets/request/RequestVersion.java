...
public class RequestVersion extends ESPPacket 
{
	byte m_destinationId;
	
	public RequestVersion(Devices _valentineType, Devices _destination)
	{
	...
	{
		super.buildPacket();
		packetIdentifier = PacketId.reqVersion.toByteValue();
