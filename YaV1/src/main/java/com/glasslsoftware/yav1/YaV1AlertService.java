...
import com.glasslsoftware.yav1.car.V1AlertRepository;
import com.glasslsoftware.yav1.car.V1CarNotifier;
...
import static com.glasslsoftware.yav1.YaV1.sPrefs;
...
public class YaV1AlertService extends Service
{
    ...
    private boolean checkMutingSpeed()
    {
        ...
        if(!rc)
            rc = com.glasslsoftware.yav1.psl.PslMute.shouldMute();
